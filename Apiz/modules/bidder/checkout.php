...
include_once 'libs/php/paypal_checkout.php';
...
$paypal_checkout = new PayPalCheckout();
$paypal_checkout->returnurl="{$home_url}place_order.php?from_paypal=1";
$paypal_checkout->cancelurl="{$home_url}cancel_order.php";
		...
		if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true){
			...
			echo "<div class='col-md-12'>";
						...
						echo "<td style='width:50%;' class='text-align-center'>";
							echo "<div class='btn-group' data-toggle='buttons'>";
								...
								echo "<label class='btn btn-default'>";
									echo "<input type='radio' name='payment_method' value='1'> PayPal";
								echo "</label>";
							echo "</div>";
						echo "</td>";
					echo "</tr>";
				...
				echo "<div class='text-align-center' style='margin:1em 0;'>";
					...
					// paypal button
					$paypal_checkout->addMultipleItems($items);
					echo $paypal_checkout->getCheckoutForm();
				echo "</div>";
			echo "</div>";
		}
		...
		// if the user was not logged in yet, tell him he cannot checkout without logging in
			...
			echo "<div class='col-md-12'>";
				echo "<div class='alert alert-danger'>";
					...
					echo "Don't have an account yet? <a href='{$home_url}register'>Register Now!</a>";
				echo "</div>";
			echo "</div>";
		}
	}
