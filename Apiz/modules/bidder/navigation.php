<!-- navbar -->
<div  class="navbar navbar-light bg-primary navbar-static-top" role="navigation">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="products.php">eauction</a>
		</div>
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
					...
					<ul class="dropdown-menu" role="menu">
						<li>
							<a href="<?php echo $home_url; ?>modules/bidder/products.php">All Products</a>
						</li>
						...
						if($num>0){
							while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
								...
								if(isset($category_name) && $category_name==$row['name']){
									echo "<li><a href='{$home_url}modules/bidder/category.php?id={$row['id']}'>{$row['name']}</a></li>";
								}
			...
			<li <?php echo $page_title=="MyBids" ? "class='active'" : ""; ?>>
					<a href="<?php echo $home_url; ?>modules/bidder/mybids.php">My Bids</a>
				</li>
			<!-- contact us page -->
			<li <?php echo $page_title=="Contact Us" ? "class='active'" : ""; ?>>
					<a href="<?php echo $home_url; ?>modules/bidder/contact.php">Contact us</a>
				</li>
