...
if($_POST){
	echo "<div class='row'>";
		...
		$price->product_id=$product_id;
			...
			if($product->update() && $price->updatePrice()){
	...
	<form action='edit_product.php?id=<?php echo $product_id; ?>' method='post' enctype="multipart/form-data">
		...
		<table class='table table-hover table-responsive table-bordered'>
			...
			<tr>
				...
				?>
				<td><input type='number' name='initial_price' value="<?php echo htmlentities($price->price); ?>" class='form-control' required /></td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<input type="date" name='active_until' id="active-until" value='<?php echo htmlentities(substr($product->active_until, 0, 10)); ?>' class='form-control' placeholder="Click to pick date" />
				</td>
			</tr>
